...
.PHONY: framework-import-test framework-snapshot-test framework-matrix-test
...
framework-snapshot-test:
	go test ./internal/framework -run 'TestEmbeddedSnapshot|TestImportDeterministic'

framework-matrix-test:
	go test ./internal/framework -run 'TestImportDeterministic'

framework-import-test: framework-snapshot-test framework-matrix-test
